...
define
   ...
   %% record OutputRec. Also prints out the attributes, node and model
   %% records.
   ...
   fun {MakeNodes DIDA OutputRec}
      ...
      NodeVs = {ListMapInd NodeOLs
		fun {$ I NodeOL}
		   ...
		   %%
		   AttrsOL = NodeOL.DIDA.attrs
		   AttrsV = {Helpers.x2V AttrsOL}
		   EntryOL = NodeOL.DIDA.entry
		   EntryV = {Helpers.x2V EntryOL}
		   ModelOL = NodeOL.DIDA.model
		   ModelV = {Helpers.x2V ModelOL}
		in
		   '<node'#
		   ' index="'#PosI#'"'#
		   ' word="'#A#'"'#
