...
define
   ...
   Option = 'shared-collapsed-dicts'
   Abstract = 'shared - collapsed keys - dicts'

   Prechecked = false
   MatrixBase = DictMatrix
...
%      if Prechecked then {DecheckOff} else {DecheckOn} end
   ...
   local
      ...
      fun {DictDot _ _ D _ F} {CondPut D F} end
      fun {NewDict _ _ _ _} {NewDictionary} end
